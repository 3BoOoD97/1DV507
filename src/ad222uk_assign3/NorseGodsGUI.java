...
public class NorseGodsGUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        arr.add(new NorseGod("Loki", "Giant", "In the comic books, Loki is the adopted brother, and arch-nemesis, of Thor but in Norse mythology he is the son of Laufey and the Jötunn Fárbauti and is Odin's blood brother. He is known as the God of Trickery and Mischief and The Father of Monsters.\n" +
                "\n" +
